...
const buyLottos = (budget) => {
    const lottoAmount = Math.floor(budget/LOTTO_PRICE);
...
const displayResult =() => {
  ...
  const userLottos = buyLottos(100000);
  ...
  console.log( `
  3개 일치 (${WIN_MONEY.THIRD})- ${win3}개
  4개 일치 (${WIN_MONEY.FOURTH})- ${win4}개
  5개 일치 (${WIN_MONEY.FIFTH})- ${win5}개
  6개 일치 (${WIN_MONEY.SIXTH})- ${win6}개
  `)
}
